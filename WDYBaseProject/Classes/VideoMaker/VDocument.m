...
-(void)updateAssetsCollection {
    ...
    NSLog(@"assetsCollection.getAssets.count 1 = %@", @(self.segmentsCollection.assetsCollection.getAssets.count));
    if (self.tmpAssetsCollection.getAssets.count > 0) {
        
        NSLog(@"assetsCollection.getAssets.count 2 = %@", @(self.segmentsCollection.assetsCollection.getAssets.count));
        
        [self.assetsCollection addArrayAssets:self.tmpAssetsCollection.getAssets];
        
        NSLog(@"assetsCollection.getAssets.count 3 = %@", @(self.segmentsCollection.assetsCollection.getAssets.count));
