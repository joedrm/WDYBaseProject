...
+ (UIImage *)my_bundleImageNamed:(NSString *)name className:(NSString *)className{
    return [self my_imageNamed:name inBundle:[NSBundle myLibraryBundleWithClassStr:className]];
}
